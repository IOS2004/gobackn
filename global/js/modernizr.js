    ...
    injectElementWithStyles(
      ...
      function (node, rule) {
        ...
        /*>>touch*/ Modernizr["touch"] =
          ...
          (hash["touch"] && hash["touch"].offsetTop) === 9; /*>>touch*/
        /*>>csstransforms3d*/ Modernizr["csstransforms3d"] =
          (hash["csstransforms3d"] && hash["csstransforms3d"].offsetLeft) ===
            9 &&
          hash["csstransforms3d"].offsetHeight === 3; /*>>csstransforms3d*/
        /*>>generatedcontent*/ Modernizr["generatedcontent"] =
          (hash["generatedcontent"] && hash["generatedcontent"].offsetHeight) >=
          1; /*>>generatedcontent*/
  ...
  (function (window, document) {
    ...
    function shivMethods(ownerDocument) {
      ...
      ownerDocument.createElement = function (nodeName) {
        ...
        var node = (
          cache[nodeName] || (cache[nodeName] = docCreateElement(nodeName))
        ).cloneNode();
